...
- 第一优先级：跟随 `upstream/main`
- 第二优先级：保持 `ralph-widex` 稳定
- Gemini / Grok / switchover 等多 LLM 集成目前按“历史能力，暂时移出主产品线”处理
- 本文件下面关于 Gemini/Grok/switchover 的细节说明仅作为历史实现参考，默认**不再视为当前 Widex 运行链路要求**
