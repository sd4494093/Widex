...
#[derive(Debug, Parser)]
#[command(
    bin_name = "widex plugin marketplace add",
    after_help = "Examples:\n  widex plugin marketplace add ./path/to/marketplace\n  widex plugin marketplace add owner/repo --ref main\n  widex plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "widex plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "widex plugin marketplace upgrade",
    after_help = "Examples:\n  widex plugin marketplace upgrade\n  widex plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "widex plugin marketplace remove",
    after_help = "Example:\n  widex plugin marketplace remove debug"
)]
